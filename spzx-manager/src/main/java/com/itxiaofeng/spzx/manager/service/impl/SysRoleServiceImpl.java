...
import com.itxiaofeng.spzx.manager.mapper.SysRoleMapper;
...
public class SysRoleServiceImpl implements SysRoleService {
    ...
    public PageInfo<SysRole> findByPage(SysRoleDto sysRoleDto, Integer pageNum, Integer pageSize) {
        ...
        List<SysRole> sysRoleslist = sysRoleMapper.findByPage(sysRoleDto);
        PageInfo<SysRole> pageInfo = new PageInfo<>(sysRoleslist);
        return pageInfo;
    }
